...
const Hero = () => {
  return (
    <div id='HeroContainer'>
      <h1>Unlock <span>10X</span> Faster & More Responsive AI-Powered <span>Copywriting</span> Tool</h1>
      <div className="buttons">
        <div id="started-btn">
          <button><span>Start Writing Free</span></button>
        ...
        <div id="demo">
          <button><span>Book A Demo</span></button>
      ...
      <img src="https://marveltheme.com/tf/html/aimug/images/resource/copywriting-tool.png" alt="" style={{position: "relative", zIndex: "2", margin: "5%"}} />
    </div>
  )
}
